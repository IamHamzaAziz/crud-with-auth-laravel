...
<body style="background-color: #f0f0f0; margin: 0; padding: 0;">
    ...
    <form action="/login" method="POST" style="width: 80%; margin: 0 auto; display: flex; flex-direction: column; align-items: center; gap: 10px;">
        @csrf
        ...
        <button type="submit" style="width: 100%; padding: 10px; border-radius: 5px; background-color: #007bff; color: white; border: none; cursor: pointer;">Login</button>
    </form>
</body>
</html>